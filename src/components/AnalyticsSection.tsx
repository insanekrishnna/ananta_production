    ...
    <section className="py-24 px-4 md:px-10">
      <div className="max-w-canvas mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-[1080px] mx-auto">
          ...
          <div className="bg-canvas border border-input rounded-[16px] p-6 shadow-float">
          ...
          <div className="bg-gradient-to-br from-[hsl(263,100%,62%)] to-[hsl(253,100%,56%)] text-primary-foreground rounded-[16px] p-6 shadow-float lg:-rotate-[6deg] hover:rotate-0 transition-transform duration-300">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-canvas border border-input rounded-[16px] p-5 shadow-float flex-1">
              ...
              <p className="text-[12px] text-text-secondary leading-[1.5] mb-3">
                The Design System project aims to establish a consistent and cohesive user experience.
              </p>
